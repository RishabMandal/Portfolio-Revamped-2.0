        ...
        >
          ...
          >
            <motion.div
              ...
              animate={{ x: 0 }}
              className="lg:flex-grow md:w-1/2 lg:pr-10 md:pr-8 flex flex-col md:items-center md:text-left mb-16 md:mb-0 items-center text-center"
            >
              <hr />
              <h1
              ...
              <p className="mb-8 leading-relaxed text-lg font-Ubuntu">
                ...
                Developer creating websites for people who know that
